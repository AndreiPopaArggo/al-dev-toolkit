 ...
 *
 * After an Edit or Write to a .al file, reminds the agent to run
 * AL: Package and drive both errors AND warnings to zero before
 * ending the turn.
 *
